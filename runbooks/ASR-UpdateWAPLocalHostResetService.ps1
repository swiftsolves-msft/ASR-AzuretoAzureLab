 ...
 Try
 {
     foreach ($VMID in $VMinfo)
    {
        ...
        If ($VM.Name -match "WAP" ) 
        {
            ...
            $url = "https://raw.githubusercontent.com/swiftsolves-msft/ASR-AzuretoAzureLab/master/scripts/updatewap.ps1"
            $guid = New-Guid
            ...
            -FileUri $url `
            -Run 'updatewap.ps1' `
            -Name "UpdateWAPhostservice-$guid"
        }
        Else 
        {
            Write-Output ("WAP VM NOT Found!")
        }
    }
 }
  Catch
